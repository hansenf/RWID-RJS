...
function NewProduct() {
    ...
    function showWidget() {
        console.log('ieu naon lieur', window.cloudinary)
        const timestamp = Math.round(Date.now() / 1000)
        const signature = window.cloudinary.utils.api_sign_request({ timestamp: timestamp, upload_preset: "konsultasi" }, "7Z-b1I5ArSHjvlO5qmclexn07UI")
        const widget = window.cloudinary.createUploadWidget(
            {
                apiKey: "323545368373634",
                cloudName: "temukandcloudinary",
                uploadPreset: "konsultasi",
